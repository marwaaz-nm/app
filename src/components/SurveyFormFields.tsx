              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-xs font-bold text-slate-600">
                    Serial Number (S/N):{' '}
                    <span className="text-teal-700 font-black text-sm ml-1">
                      {draft.serial_no ? `#${draft.serial_no}` : 'Toos loo siinayaa marka la kaydiyo (Auto on save)'}
                    </span>
                  </div>
                  <div className="text-[11px] text-slate-500 font-medium">
                    {draft.serial_no
                      ? 'Tiro-taxanaha sahankan.'
                      : 'Tiro-taxanaha sahankan waxaa toos u xisaabinaya server-ka xilliga la kaydiyo (Save) si aysan u dhicin duplicate.'}
                  </div>
                </div>
              </div>
              <span className="text-[11px] font-black px-2.5 py-1 rounded-lg bg-teal-100/80 text-teal-800">
                {draft.serial_no ? `S/N #${draft.serial_no}` : 'Auto S/N'}
              </span>
            </div>
          </div>
