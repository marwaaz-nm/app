...
const DESKTOP_INSTALLER_SIZE = 100246277;
          ...
          {tab === 'desktop' && (
            <div className="space-y-5">
              ...
              <div className="bg-white border border-slate-100 rounded-3xl p-6 space-y-5 shadow-sm">
                ...
                <p className="text-[11px] text-slate-400 font-medium">
                  Android 7 ama ka cusub ayuu u shaqeeyaa. Haddii nooc hore ku jiro, hal mar uninstall-garee ka hor rakibidda v1.1.3; kadibna oggolow “Install unknown apps”.
                </p>
              </div>
            </div>
          )}
