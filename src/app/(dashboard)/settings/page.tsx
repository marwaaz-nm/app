...
export default function SettingsPage() {
  ...
  return (
    <div className="p-4 md:p-8 mx-auto space-y-3.5 md:space-y-6 text-slate-800 w-full max-w-4xl">
      <div className="flex items-center gap-3 bg-white p-3 md:p-6 rounded-2xl md:rounded-3xl border border-slate-100 shadow-sm w-full">
        <div className="bg-teal-50 text-teal-600 p-2 rounded-xl border border-teal-100 shrink-0">
          <SettingsIcon className="h-5 w-5" />
        </div>
        <div>
          <h2 className="text-base md:text-xl font-black text-slate-800 leading-tight">Settings</h2>
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 shrink-0 rounded-xl px-4 py-2.5 text-xs font-bold transition-all cursor-pointer ${
                tab === t.id ? 'bg-teal-600 text-white shadow-md' : 'bg-white border border-slate-200 text-slate-600 hover:bg-slate-50'
              }`}
            >
